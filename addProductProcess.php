                    ...
                    <div class="table-repsonsive">
                       <table class="table table-borderless" id="item_table">
                        ...
                        <tr>
                          ...
                          <td><input type="number" name="timemin[]" class="form-control" placeholder="0" required></td>
...
<script type="text/javascript">
  $(document).ready(function(){
   ...
   $(document).on('click', '.add', function(){
      ...
      html += '<td><input type="number" name="timemin[]" class="form-control" placeholder="0" required></td>';
